...
/******/ 	var hotCurrentHash = "ca11a2e49592d691722d"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'detail/:repo', component: _Detail2.default })
	);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'h1',
	                    null,
	                    'Unofficial GitHub Browser v1.0 for saoleigroup'
	                ),
	                this.props.children
	            );
	        }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _reactRouter.Link,
	                            { to: '/detail/transform-app-server' },
	                            'transform-app-server'
	                        )
	                    )
	                )
	            );
	...
	var Detail = function (_Component) {
	    ...
	    _createClass(Detail, [{
	        ...
	        value: function fetchFeed(type) {
	            ...
	            var baseURL = 'https://api.github.com/repos/saoleigroup';
	            _SuperAgent2.default.get(baseURL + '/' + this.props.params.repo + '/' + type).end(function (error, response) {
	                if (!error && response) {
